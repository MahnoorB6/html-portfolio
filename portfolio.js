...
// Prevent browser scroll restoration from reopening the page halfway down.
...
// Always start the normal homepage at the top. Hash links are left untouched.
window.addEventListener('load',()=>{if(!location.hash) window.scrollTo({top:0,left:0,behavior:'instant'});});
